...
$(document).ready(function() {
    ...
    Bartender.prototype.createDrink = function(userPrefs) {
      var drink = "Your drink has a ";
      for (var prop in userPrefs) {
        if (userPrefs[prop] !== '') {
          currentPantry[userPrefs[prop]]--;
    ...
    for (var i = 0; i < questionsList.length; i++) {
        ...
        if (userInput === 'Y') {
            ...
            //     if (currentPantry[currentIngredient.ingredientsList[num]] !== 0) {
            //         currentPantry[currentIngredient.ingredientsList[num]]--;
            //         console.log(currentPantry[currentIngredient.ingredientsList[num]]);
            //         return num;
            //     }
            // }
            userPreferences[currentIngredient.preference] = currentIngredient.ingredientsList[num];
            // finalDrink.createDrink();
        }
        console.log(userPreferences);
    }
    finalDrink.createDrink (userPreferences);
    console.log(strongPantry);
    console.log(sweetPantry);
    console.log(saltyPantry);
    console.log(bitterPantry);
